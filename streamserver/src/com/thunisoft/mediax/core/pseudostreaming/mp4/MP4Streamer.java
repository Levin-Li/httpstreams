 ...
 * @author chenxh
 */
public class MP4Streamer extends AbstractStreamer implements IStreamer {


    public MP4Streamer(RandomAccessChannel channel) throws FileNotFoundException {
        super(channel);
    }


    public void transfer(double startAt, WritableByteChannel outChannel) throws IOException {
        Movie movie = MovieCreator.build(new LocalDataSource(channel));
